...
namespace Accounting_system {
    ...
    public partial class DatabaseDataSet4 : global::System.Data.DataSet {
        ...
        public partial class GoodsDataTable : global::System.Data.TypedTableBase<GoodsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public GoodsRow AddGoodsRow(string Name, int Quantity) {
...
namespace Accounting_system.DatabaseDataSet4TableAdapters {
    ...
    public partial class GoodsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Goods] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND" +
                " [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Quantity = 1 AND [Q" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Goods] ([Name], [Quantity]) VALUES (@Name, @Quantity);\r\nSELECT" +
                " Id, Name, Quantity FROM Goods WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Goods] SET [Name] = @Name, [Quantity] = @Quantity WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)));
SELECT Id, Name, Quantity FROM Goods WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Quantity FROM dbo.Goods";
        ...
        public virtual int Fill(DatabaseDataSet4.GoodsDataTable dataTable) {
        ...
        public virtual DatabaseDataSet4.GoodsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet4.GoodsDataTable dataTable = new DatabaseDataSet4.GoodsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet4.GoodsDataTable dataTable) {
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> Quantity) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Quantity, int Original_Id, string Original_Name, global::System.Nullable<int> Original_Quantity, int Id) {
            if ((Name == null)) {
